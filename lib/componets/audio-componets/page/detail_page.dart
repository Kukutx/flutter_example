...
class DetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      resizeToAvoidBottomInset : false,                // bottom overflowed by pixels flutter   问题
      appBar: AppBar(title: Text(musicModel.name),),
      body: SingleChildScrollView(child:               // bottom overflowed by pixels flutter   问题
      Center(
        child: Column(
          children: [
            Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(size.width*0.3),
                child: Image.asset("assets/images/audio-images/p${musicModel.id}.jpg",width: size.width*0.6,height: size.width*0.6,fit: BoxFit.cover),
              ),
            ),
